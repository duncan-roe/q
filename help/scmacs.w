...
fm-s -l
t1 81
N A '^NC^NS^N\O OFF^JA^J^I^I^NR2^NOB^[M1,32000^J^NA^n^<706>^NG>^n^<700>^n^<702> Fit into TAB2-1
...
N705 ^B^?^T^n^<702> ;This wd won''t fit: back 1 wd, ER space, split line
...
N255 ^NU ; Used by the ^N^C^W LQP suite
...
Z
 The ^N^W^W macro is similar to the ^N^C^W macro described below,
except that headers and footers are not output on the first page, nor is
the page count incremented.
 The ^N^C^W macro produces a document for LQP spooling.
